                ...
                using(SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        Dog dog = new Dog
                        {
                            ...
                            Notes=Utilities.ReaderUtil.GetNullableString(reader,"Notes"),
                            ImageUrl=Utilities.ReaderUtil.GetNullableString(reader, "ImageUrl")
                        };
                        dogs.Add(dog);
                    }
                    reader.Close();
        ...
        public void AddDog(Dog dog)
        {
            using(SqlConnection conn = Connection)
            {
                ...
                using(SqlCommand cmd= conn.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@notes", Utilities.ReaderUtil.GetNullParam(dog.Notes));
                    cmd.Parameters.AddWithValue("@imageUrl", Utilities.ReaderUtil.GetNullParam(dog.ImageUrl));
